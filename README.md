...
Вещи, которые мы ищем в Интернете, могут многое рассказать о нас, даже если рассматривать их в совокупности на анонимном уровне. В течение многих лет Google предоставлял некоторые из этих поисковых данных для просмотра через веб-сайт Google Trends, который позволяет отображать изменения в различных поисковых запросах с течением времени.

Данные Google Trends уже давно используются теми, кто работает в сфере электронной коммерции и маркетинга, поскольку они дают представление о терминах, которые используют люди, и об изменении их популярности с течением времени. Это не только дает полезную информацию о том, какие ключевые слова лучше всего использовать в контенте или какие продукты лучше всего продвигать, но и лежащие в основе данные также могут использоваться учеными, работающими с данными, в рамках прогнозных моделей.

Использование данных Google Trends в моделях
Использование данных Google Trends в моделях не является чем-то новым и применяется в ряде различных областей исследований, от финансов до здравоохранения. Вот подборка некоторых недавних случаев использования из различных статей:

Болезнь Лайма: Seifter et al. (2010) использовали данные Google Trends в эпидемиологических исследованиях, отслеживающих распространение болезни Лайма, потенциально опасной для жизни клещевой инфекции. Они смогли использовать данные о результатах поиска по запросу «болезнь Лайма», чтобы определить районы, в которых болезнь Лайма была эндемической и люди подвергались наибольшему риску заражения.


Надзор за здравоохранением: Nuti et al. (2014) охватил 70 медицинских исследований, в которых использовались данные Google Trends для наблюдения за здравоохранением. Они выявили четыре основные тенденции: инфекционные заболевания (27% статей), психическое здоровье и злоупотребление психоактивными веществами (24% статей), неинфекционные заболевания (16% статей) и поведение населения в целом (39% статей).

Коронавирус: Стшелецкий и Ризун (2020) изучили поисковые запросы по словам «коронавирус», «сарс» и «мерс» и смогли определить пики заражения по объемам поиска и определить наиболее пострадавшие регионы. Они обнаружили, что данные Google Trends прогнозируют рост новых случаев заболевания, и предложили национальным службам здравоохранения использовать их в качестве индикатора предстоящего роста числа пациентов.


Прогноз текущей погоды: Карьер-Сваллоу и Лаббе (2011) использовали данные Google Trends для прогнозирования текущей погоды в экономических моделях. Они показали, что данные Google Trends были полезны, поскольку они не публиковались с «задержкой», наблюдаемой в других экономических показателях. Эйхенауэр и др. (2020) недавно сообщили об использовании этого метода для изучения ежедневных настроений.

Загрузите пакеты
В этом проекте мы рассмотрим, как можно извлечь данные из Google Trends, чтобы получить ценную информацию или использовать их в моделях с помощью превосходного пакета PyTrends. Это работает хорошо, но, поскольку это неофициально, существует риск того, что он может перестать работать, если Google изменит способ доступа к своим данным, поэтому вам нужно быть осторожным при использовании его в производственной ситуации.

Для начала откройте блокнот Jupyter и установите пакет PyTrends с помощью Pip, если он у вас еще не установлен. Из pytrends.requestмодуля импортируйте TrendReqпакет и создайте экземпляр нового TrendReq()объекта. Я позвонил своему ptдля краткости. При создании экземпляра вы можете передавать различные необязательные аргументы, TrendReq()включая смещение timeout, tzили часового пояса, список proxiesзаблокированных вами Google, количество retriesи язык хоста или hl. !pip установить pytrends
